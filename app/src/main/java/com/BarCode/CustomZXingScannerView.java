...
/**
 * Created by poem on 3/19/2017.
 */

public class CustomZXingScannerView extends View implements IViewFinder {
    private static final String TAG = "ViewFinderView";
    private static final float PORTRAIT_WIDTH_RATIO = 5f / 8;//6f/8
    private static final float PORTRAIT_WIDTH_HEIGHT_RATIO = 0.65f;//0.75f
    ...
    //private final int mDefaultLaserColor = ContextCompat.getColor(context, R.color.colorPrimary)getResources().getColor(R.color.viewfinder_laser);
    //private final int mDefaultMaskColor = getResources().getColor(R.color.viewfinder_mask);
    //private final int mDefaultBorderColor = getResources().getColor(R.color.viewfinder_border);

    private final int mDefaultLaserColor = 0x7f0d008b;
    private final int mDefaultMaskColor = 0x7f0d008c;
    private final int mDefaultBorderColor = 0x7f0d008a;
    ...
    public void drawViewFinderBorder(Canvas canvas) {
        ...
        canvas.drawLine(framingRect.left - 1, framingRect.top - 1,
                framingRect.left - 1, framingRect.top - 1 + mBorderLineLength, mBorderPaint);
        canvas.drawLine(framingRect.left - 1, framingRect.top - 1,
